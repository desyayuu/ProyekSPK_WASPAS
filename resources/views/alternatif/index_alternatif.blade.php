...
<button data-modal-target="crud-modal" data-modal-toggle="crud-modal" class="block text-white bg-first hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-first dark:focus:ring-blue-800 relative overflow-x-auto shadow-md sm:rounded-lg mx-4 my-4" type="button">
    Tambah Alternatif
</button>
<!-- Main modal -->
    ...
    <!-- Modal content -->
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form class="p-4 md:p-5" method="post" action="{{route('alternatif.store')}}" id="myForm" enctype="multipart/form-data">
                ...
                <button type="submit" class="text-white inline-flex items-center bg-first hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-first dark:focus:ring-blue-800">
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        <thead class="text-xs text-gray-700 uppercase bg-gray-100 dark:bg-gray-700 dark:text-gray-400">
            <tr>
                ...
                <th scope="col" class="px-3 py-2 rounded-e-lg">
                    Action
                </th>
            </tr>
        </thead>
            ...
            <tr class="bg-white dark:bg-gray-800">
                ...
                <td class="px-6 py-4">
                    <div class="flex items-center">
                        <button data-modal-target="crud-modal-{{ $Alternatif->id }}" data-modal-toggle="crud-modal-{{ $Alternatif->id }}" class="text-white bg-first hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-1.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-first dark:focus:ring-blue-800" type="button">
                            Edit
                        </button>
                    <!-- Main modal -->
                        ...
                        <form method="post" action="{{ route('alternatif.destroy', $Alternatif->id) }}" id="deleteForm-{{ $Alternatif->id }}" enctype="multipart/form-data">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="text-white bg-fifth hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-3 py-1.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-first dark:focus:ring-blue-800" onclick="return confirmDelete({{ $Alternatif->id }})">
                                Delete
                            </button>
                        </form>
